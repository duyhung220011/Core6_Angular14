...
export class DepartmentViewComponent implements OnInit, OnDestroy {
   ...
   */
  constructor(private router: Router, private _departmentViewService: DepartmentViewService) {
   ...
   */
  ngOnInit(): void {
    this._departmentViewService.onDepartmentViewChanged.pipe(takeUntil(this._unsubscribeAll)).subscribe(response => {
      this.data = response;
    });
  }
